...
def img_up(url):
    imgurl = "https://img.202014.xyz/api/1/upload/?key=50406be2f7bf41445ea5b31ff2fd456d&source={}&format=txt".format(url)
    #如果遇到错误就出试5次
    success_num = 0
    while success_num < 5:
        try:
...
def img_post_up(url):
    ...
    while success_num < 5:
        try:
            ...
            res = s.post(
                url="https://img.202014.xyz/api/1/upload/?key=50406be2f7bf41445ea5b31ff2fd456d&format=txt",  # HTML文本翻译
...
def html_img_up(html):
    ...
    for img,new_img in zip(imgurls,img_202014s):
        html = new_html
        new_html = html.replace(img,new_img,1)
...
if __name__ == '__main__':
    ...
    # pool = Pool()
    # for i in range(1,2):
    #     url = "https://i.acg.blue:4443/images/2020/09/15/84306688.jpg"
    #     pool.apply_async(func=img_post_up, args=(url,))  # 多进程运行
    #     # print(img_up("https://img.202014.xyz/imgs/2020/04/7f9c0bdf20c071f3.png"))
    # pool.close()
    # pool.join()
